...
> In this project we created a class and a module in a separate file. 
  We used the import possibilities to insert the module into the class. The module implements some functionalities
  of the Enumerable mixin.
...
`cd YOUR_FOLDER_NAME`
`git clone https://github.com/MattGomb/create-enumerable.git`
